          ...
          {[
            ...
            <div key={i} className="group space-y-4 wool-card wool-fade-up" style={{ "--delay": `${0.2 + i * 0.08}s` }}>
              <div className="relative aspect-[3/4] overflow-hidden rounded-xl bg-slate-200">
                <img alt={item.title} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 wool-card-image" decoding="async" loading="lazy" src={item.img} />
                {item.tag && (
