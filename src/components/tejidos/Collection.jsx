        ...
        <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                <div className="space-y-4">
                    <h2 className="text-4xl md:text-5xl font-['Playfair_Display',serif] font-medium wool-heading wool-fade-up" style={{ "--delay": "0.1s" }}>
                      La Edición de Otoño
                    </h2>
                    <p className="wool-text max-w-md wool-fade-up" style={{ "--delay": "0.2s" }}>
                      Una exploración de capas de lana orgánica teñidas naturalmente, diseñadas para perdurar en el tiempo.
                    </p>
                </div>
                <a className="group flex items-center gap-2 text-[color:var(--color-accent)] font-bold border-b-2 border-[color:var(--color-accent)]/25 pb-1 hover:border-[color:var(--color-accent)] transition-all wool-link wool-fade-up" href="#top" style={{ "--delay": "0.3s" }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                {[
                    ...
                    <div key={i} className="group space-y-4 wool-card wool-fade-up" style={{ "--delay": `${0.2 + i * 0.08}s` }}>
                        <div className="relative aspect-[3/4] overflow-hidden rounded-xl bg-slate-200">
                            <img alt={item.title} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 wool-card-image" src={item.img} />
                            {item.tag && (
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-xs wool-muted mt-1 uppercase tracking-widest">{item.sub}</p>
                        </div>
                    </div>
                ))}
            </div>
