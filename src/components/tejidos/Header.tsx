        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            <div className="flex items-center gap-12">
                ...
                <nav className="hidden md:flex items-center gap-8">
                    <a className="text-sm font-semibold hover:text-[#d2691e] transition-colors" href="#">Galería Completa</a>
                    <a className="text-sm font-semibold hover:text-[#d2691e] transition-colors" href="#">El Oficio</a>
                    <a className="text-sm font-semibold hover:text-[#d2691e] transition-colors" href="#">Materiales</a>
                    <a className="text-sm font-semibold hover:text-[#d2691e] transition-colors" href="#">Archivo</a>
                </nav>
            </div>
            <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-4">
                    <a className="text-xs uppercase tracking-widest font-bold text-[#d2691e] hover:text-[#3A5B3A] transition-colors border-b border-[#d2691e]/20 pb-0.5" href="#">Catálogo Digital</a>
                    <a className="text-xs uppercase tracking-widest font-bold hover:text-[#d2691e] transition-colors" href="#">Contacto</a>
                </div>
            </div>
        </div>
    </header>
