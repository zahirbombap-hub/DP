      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white/80 dark:text-slate-400">
              <li className="flex items-center gap-2"><span className="material-symbols-outlined text-sm">schedule</span> Lun - Sáb: 8am - 6pm</li>
              <li className="flex items-center gap-2"><span className="material-symbols-outlined text-sm">location_on</span> Sutamarchán, Boyacá</li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white/80 dark:text-slate-400">
              <li><a className="hover:text-white dark:hover:text-[#0077BE]" href="#top">Términos y Condiciones</a></li>
              <li><a className="hover:text-white dark:hover:text-[#0077BE]" href="#top">Política de Privacidad</a></li>
            </ul>
          </div>
        </div>
