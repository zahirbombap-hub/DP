export function ProductCatalog() {
  const products = [
    {
      title: "Pack 600ml",
      desc: "Ideal para eventos y deportistas. Máxima frescura portátil.",
      price: "$12.000",
      tag: "Pack x 6",
    ...
    {
      title: "Garrafa 5L",
      desc: "Perfecta para oficinas y hogares pequeños. Fácil manejo.",
      price: "$6.000",
          ...
          {products.map((item, i) => (
            <div key={i} className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-100 dark:border-slate-800 group hover:shadow-2xl transition-all hover:-translate-y-2">
              <div className="bg-slate-100 dark:bg-slate-800 rounded-2xl h-64 mb-6 flex items-center justify-center relative overflow-hidden">
                <img alt={item.title} className="h-full w-full object-cover group-hover:scale-110 transition-transform duration-500" src={item.img}/>
