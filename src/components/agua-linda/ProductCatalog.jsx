export function ProductCatalog() {
  const products = [
    ...
    },
    {
      ...
      tag: "Pack x 20",
      ctaLabel: "Quiero mi Bolsa",
      img: "https://lh3.googleusercontent.com/aida-public/AB6AXuCBY08cnI2l6pUcnCbiUdQ0SnNDMyVVbwN-mn6bvcyfiBZSX1VK-L7TIuNswEZDpbb2OOX_iAPsVg08Ydy8THqvAbvU7lxdzlIUlAu_jONDCpyNdH3XU0VGKCdjI--fPHTBWJUP6q5eL1srAz0Bqp-XuebF4FDxrnuggG9T0iImOAKVzdrxDDyzO2rLNb02bbJoYSRwKDTSK-gLq091mel6Bp_j7MZ3cgQWzI5hAprV_e6XQ-VrvQEIBtwUuZkT1EMTVFRXDz0c8A",
    },
    {
      title: "Garrafa 5L",
      desc: "Perfecta para oficinas y hogares pequeños. Fácil de manejar.",
      ctaLabel: "Quiero mi Garrafa",
          ...
          {products.map((item, i) => (
            <div key={i} className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-100 dark:border-slate-800 group hover:shadow-2xl transition-all hover:-translate-y-2">
              ...
              <div className="flex items-center justify-between gap-4">
                ...
                <button className="inline-flex items-center justify-center rounded-full bg-slate-100 dark:bg-slate-800 px-4 py-2 text-sm font-semibold text-slate-800 dark:text-white hover:bg-[#0077BE] hover:text-white transition-all">
                  {item.ctaLabel}
                </button>
              </div>
            </div>
