...
export function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 px-6 py-4 border-b border-[#8a0012]/30 bg-[#050505]/90 backdrop-blur-xl cinematic-load">
      <div className="max-w-screen-2xl mx-auto flex items-center justify-between">
        <a aria-label="Don Prueba Inicio" className="flex items-center gap-4 group" href="/" onClick={() => window.location.reload()}>
          ...
          <span className="font-['JetBrains_Mono',monospace] text-lg font-extrabold tracking-tighter uppercase hidden sm:block text-white">
          ...
          <div className="lg:hidden relative">
            ...
            >
              <nav className="flex flex-col text-sm">
                <a href="#cases-section" title="Ir a Páginas" className="px-4 py-3 hover:bg-white/3">Páginas</a>
                <a href="#how-it-works" title="Ir a Proceso" className="px-4 py-3 hover:bg-white/3">Proceso</a>
                <a href="#contact-footer" title="Ir a Contáctanos" className="px-4 py-3 hover:bg-white/3">Contáctanos</a>
              </nav>
            </div>
          </div>
          ...
          <button
            onClick={() => {
              ...
              if (target) {
                ...
                const firstInput = document.getElementById('company-name') as HTMLElement | null;
            ...
            className="cta-button text-white px-5 py-2 text-[10px] font-black uppercase tracking-widest active:scale-95"
          >
            Iniciar Proyecto
          </button>
        </div>
